...
<%
	...
	String processMETHOD = "media_main";
...
<script type="text/javascript">  
        ...
        {        	
                ...
                columns: [
	                ...
	                { display: '点播媒体分类封面', name: 'image', width: 150, 
	                	render:function(rowdata,rowindex)
			 	    	{
							return "<img src='data:image/png;base64,"+rowdata.image+"' onclick=\"bigImg(this,'"+rowdata.type_name+"')\" width='150' height='50'/>";
			 	    	}
	                },
	                { display: '点播媒体分类高亮封面', name: 'image_sel', width: 150, 
	                	render:function(rowdata,rowindex)
			 	    	{
							return "<img src='data:image/png;base64,"+rowdata.image_sel+"' onclick=\"bigImg(this,'"+rowdata.type_name+"')\" width='150' height='50'/>";
			 	    	}
	                },
	                { display: '排序', name: 'order_no', id:'order_no', align: 'left', width: 80 },	
	                { display: '所属机构编号', name: 'institution', width: 150 },	                
			...
			$form = $("#mainform").ligerForm({
	        	...
	        	fields:[	//表单栏位	        	    
	        		...
	        		{ display: "点播媒体分类名称",name:"type_name",type:"text",validate:{required:true}},
	        		...
	        		{ display: "所属机构编号",name:"institution",type:"text",validate:{required:false}}
	        	],
        ...
        function toolbarAction(item)
        {
        	action = item.icon;
        	if (action == "add"){
        		$form.setData({type_id:'',server_type:'',type_name:'',ip:'',url_prefix:'',image:'',image_sel:'',order_no:'',institution:''});
        		$form.setEnabled(['type_id','type_name','super_id','image','image_sel','order_no','institution'],true);
        		...
        		$form.setData(select);
        		$form.setEnabled(['type_name','super_id','image','image_sel','order_no','institution'],true);
        		...
        		$form.setData(select);
        		$form.setEnabled(['type_id','type_name','super_id','image','image_sel','order_no','institution'],false);        		
        	}
