...
<body style="padding:10px; overflow:auto; text-align:center;background:#FFFFFF;"> 
        ...
        <b><span id="labelusername"><shiro:principal /></span><span>，</span><span id="labelwelcome"></span><span>欢迎登录 方晟达播控中心</span></b>
        ...
        <b>方晟达播控中心帮助</b> 
         ...
         <div id="guides">
	     <ul>
	     <li><span>访问<a href="http://www.fstar.com.cn/" target="_blank">方晟达主页</a>，获取最新资讯与信息</span></li>
	     <br/>
	     <li><span>如何使用方晟达播控中心，查看<a href="" target="_blank">在线使用指南</a></span></li>
	     <br/>
